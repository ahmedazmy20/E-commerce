        ...
        <div className="max-w-2xl ">
            <div className="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="px-5 pb-5">
                    ...
                    <p className=' line-clamp-2 my-4'>{product.description}</p>
                    ...
                    <div className="flex items-center justify-between flex-col md:flex-row ">
                        ...
                        <button onClick={() => addProductToCart(product._id, userToken)} className="text-white bg-blue-700 hover:bg-blue-800 focus:bg-green-500 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-xs px-2 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ">Add to cart</button>

            ...
            <div className="mx-auto w-full">
                <div className="rounded-lg  w-full">
                    {wishlist?.data.map((product, index) => {
                        return <div key={index} className="flex flex-col md:flex-row justify-between items-center m-4">
                            <img src={product.imageCover} alt="whishlist-image" className=" rounded-lg w-52 " />
                            <div className="p-10 text-center md:text-start">
                                ...
                                <p className="text-sm text-gray-700">{product.sold} Sold</p>

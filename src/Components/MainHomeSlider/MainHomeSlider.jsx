...
export default function MainHomeSlider() {
  ...
  return (<>
    <div className='flex '>
      <div className='w-3/4'>
        <Slider  {...settings}>
          <img src={slid1} className='w-full h-[500px]' alt="" />
          <img src={slid2} className='w-full h-[500px]' alt="" />
          <img src={slid3} className='w-full h-[500px]' alt="" />
        </Slider>
      </div>
      <div className='w-1/4  '>
        <img src={slid4} className='w-full h-[250px]' alt="" />
        <img src={slid5} className='w-full h-[250px]' alt="" />
      </div>
